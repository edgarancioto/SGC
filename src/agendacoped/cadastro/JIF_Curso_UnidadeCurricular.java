...
public class JIF_Curso_UnidadeCurricular extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        queryCursos = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Cursos a");
        queryArea = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Areas a");
        queryUnidades = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM UnidadeCurricular a");
        listCursos = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : org.jdesktop.observablecollections.ObservableCollections.observableList(queryCursos.getResultList());
        ...
        listUnidades = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : queryUnidades.getResultList();
        ...
        btn_novoUnidade = new javax.swing.JButton();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Unidades Curriculares"));
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.unidadeCurricularCollection}");
        jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, eLProperty, masterTableUnidade);
        ...
        bindingGroup.addBinding(jTableBinding);
        jTableBinding.bind();
        jScrollPane1.setViewportView(masterTableUnidade);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTableUnidade, org.jdesktop.beansbinding.ELProperty.create("${selectedElement!=null}"), spin_cargaUnidade, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTableUnidade, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.cargaH}"), spin_cargaUnidade, org.jdesktop.beansbinding.BeanProperty.create("value"));
        bindingGroup.addBinding(binding);

        btn_novoUnidade.setText("Novo");
        btn_novoUnidade.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_novoUnidadeActionPerformed(evt);
            }
        });
    ...
    private void btn_novoUnidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_novoUnidadeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_novoUnidadeActionPerformed
    ...
    private javax.swing.JButton btn_novoUnidade;
    ...
    private java.util.List<agendacoped.bean.UnidadeCurricular> listUnidades;
    ...
    private javax.persistence.Query queryUnidades;
