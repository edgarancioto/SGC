...
public class JIF_VisualizacaoRapida extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        dataConverter1 = new sgc.validation.DataConverter();
    ...
    private sgc.validation.DataConverter dataConverter1;
    ...
    private java.util.List<sgc.bean.Calendario> listCalendario;
    private java.util.List<sgc.bean.Calendario> listCalendarioFull;
