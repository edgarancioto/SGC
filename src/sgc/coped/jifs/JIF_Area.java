...
public class JIF_Area extends javax.swing.JInternalFrame {
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        try {
            ...
            entityManager.getTransaction().begin();
            List<sgc.bean.Areas> merged = new ArrayList<>(list.size());
            for (sgc.bean.Areas a : list) {
    ...
    private void btn_novoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_novoActionPerformed
        busca("");
        sgc.bean.Areas a = new sgc.bean.Areas();
    ...
    private void btn_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_excluirActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(null, "Deseja realmente excluir "+((selected.length==1)?"este registro?":"estes registros?"))==0){
            List<sgc.bean.Areas> toRemove = new ArrayList<>(selected.length);
            for (int idx = 0; idx < selected.length; idx++) {
                sgc.bean.Areas a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(a);
    ...
    private java.util.List<sgc.bean.Areas> list;
