...
public class JIF_Curso extends javax.swing.JInternalFrame {
    ...
    private void btn_novoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_novoActionPerformed
        busca("");
        sgc.bean.Cursos a = new sgc.bean.Cursos();
        listCursos.add(a);
    ...
    private void btn_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_excluirActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(null, "Deseja realmente excluir "+((selected.length==1)?"este registro?":"estes registros?"))==0){
            List<sgc.bean.Cursos> toRemove = new ArrayList<>(selected.length);
            for (int idx = 0; idx < selected.length; idx++) {
                sgc.bean.Cursos a = listCursos.get(masterTableCursos.convertRowIndexToModel(selected[idx]));
                toRemove.add(a);
            ...
            try {
                ...
                entityManager.getTransaction().begin();
                List<sgc.bean.Cursos> merged = new ArrayList<>(listCursos.size());
                for (sgc.bean.Cursos a : listCursos) {
    ...
    private java.util.List<sgc.bean.Cursos> listCursos;
